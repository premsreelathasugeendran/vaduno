  ...
  return (
    <>
      <div className="page-lead reveal s1">
        ...
        <p className="lead-sub">Workspace &amp; access for this Paygent console.</p>
      </div>
        ...
        <div className="setting-row">
          <div>
            ...
            <div className="setting-desc">
              {isDefault
                ? "Using the demo default. Set PAYGENT_DASHBOARD_PASSCODE for production."
                : "Configured via PAYGENT_DASHBOARD_PASSCODE."}
            </div>
          </div>
      ...
      <div className="panel reveal s3">
        ...
        <div className="setting-desc" style={{ lineHeight: 1.7 }}>
          Paygent governs and records AI-agent payments — it never holds funds or keys.
          This console reads the tamper-evident ledger produced by <code>@paygent/guard</code> and
