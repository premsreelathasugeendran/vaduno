/**
 * Vaduno demo: an AI agent with a $50 budget tries a series of purchases —
...
// Stripe issuing call, or UPI collect. Vaduno never touches the money and
...
// ── Scenario ─────────────────────────────────────────────────────────────
console.log("— Vaduno demo: agent with $50/day budget, $20/txn cap —\n");
...
const stormGuard = new VadunoGuard({
  policy: {
    id: "storm-policy",
    version: 1,
    currency: "USD",
