/**
 * Paygent revocation demo — the kill switch, honestly scoped.
 *
...
console.log("— Paygent revocation registry demo —\n");
...
const outageGuard = new PaygentGuard({
  policy,
  ledger: outageLedger,
...
const hungRegistry = new RevocationRegistry({
  issuer: "prem@paygent.dev",
  listId: "https://paygent.example/status/2",
  privateKeyPem: keys.privateKeyPem,
...
console.log(
  "\nScope note: revocation is INSTANT and GUARANTEED for mandates Paygent mediates.",
);
console.log(
