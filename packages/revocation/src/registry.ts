import type { AuditLedger } from "@paygent/guard";
 ...
 *  - For mandates Paygent issues, revocation is INSTANT and GUARANTEED,
 ...
 *  - For authority Paygent does NOT mediate (a raw wallet key the agent holds,
 *    a card issued outside Paygent), revocation is BEST-EFFORT fan-out to each
