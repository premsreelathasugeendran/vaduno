 ...
 * + encodedList) but signed with the same Ed25519 construction Paygent uses
 ...
 * is reversible. Paygent enforces that distinction — un-revoking is refused.
 */
...
const STATUS_LIST_DOMAIN = "paygent-status-list/v1\n";
