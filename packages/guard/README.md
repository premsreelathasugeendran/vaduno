...
Paygent puts deterministic code between your agent and the money:
...
```ts
import { PaygentGuard, AuditLedger, MemoryLedgerStore } from "@paygent/guard";
...
const result = await guard.execute(
  ...
  () => myPaymentClient.pay(...),   // your executor — Paygent never touches the money
);
...
**Paygent never holds funds, keys, or the ability to move money.** It decides whether *your* executor function may run, and records everything.
...
| Package | What |
|---|---|
| [`@paygent/x402`](https://www.npmjs.com/package/@paygent/x402) | Governs Coinbase x402 HTTP-402 stablecoin payments |
| [`@paygent/stripe`](https://www.npmjs.com/package/@paygent/stripe) | Makes the guard the real-time authorization brain for Stripe Issuing cards |
| [`@paygent/transparency`](https://www.npmjs.com/package/@paygent/transparency) | RFC 9162 Merkle transparency log + C2SP witness cosigning |
| [`@paygent/revocation`](https://www.npmjs.com/package/@paygent/revocation) | Enforced kill switch + W3C Bitstring Status Lists |

## Security

Read [SECURITY.md](https://github.com/premsreelathasugeendran/paygent/blob/master/SECURITY.md) for the threat model, what this defends against, and the **known limitations** — they are documented, not hidden.

Report vulnerabilities via [GitHub Security Advisories](https://github.com/premsreelathasugeendran/paygent/security/advisories/new).
